...
```bash
$ curl -fsSL https://github.com/fredrikekre/jlpkg/releases/download/v1.3.1/jlpkg-v1.3.1.tar.gz | \
...
$ curl -fsSL -o ~/.bash_completion.d/jlpkg-completion.bash \
  https://raw.githubusercontent.com/fredrikekre/jlpkg/v1.3.1/src/jlpkg-completion.bash
```
